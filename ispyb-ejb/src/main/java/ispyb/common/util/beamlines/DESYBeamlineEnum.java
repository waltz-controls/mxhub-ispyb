...
/**
 * This class represents a beamline at DESY.
...
public enum DESYBeamlineEnum {
	...
	public static DESYBeamlineEnum retrieveBeamlineWithName(String aName){
		for(DESYBeamlineEnum b: DESYBeamlineEnum.values()){
	...
	public static String retrieveDirectoryNameWithName(String aName){
		DESYBeamlineEnum beamline = retrieveBeamlineWithName(aName);
		if(beamline != null){
	...
	public static String[] getBeamlineNames(){
		String[] list = new String[DESYBeamlineEnum.values().length];
		int i=0;
		for(DESYBeamlineEnum b: DESYBeamlineEnum.values()){
